...
import com.heima.model.wemedia.vos.WmLoginVo;
...
//            wmLoginVo.setId(wmUser.getId());
//            wmLoginVo.setName(wmUser.getName());
//            wmLoginVo.setPhone(wmUser.getPhone());
//            map.put("user",wmLoginVo);
            map.put("user", wmUser);
